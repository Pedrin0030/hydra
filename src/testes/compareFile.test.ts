...
const {
  compareFile,
} = require("../src/main/services/achievements/achievement-watcher-manager"); // Atualize o caminho para o arquivo compareFile
...
describe("compareFile", () => {
  ...
  it("should call compareFltFolder when file.type is Cracker.flt", () => {
    ...
    const {
      compareFltFolder,
    } = require("../src/main/services/achievements/compareFltFolder");
  ...
  it("should call processAchievementFileDiff when first change in file", () => {
    ...
    const {
      processAchievementFileDiff,
    } = require("../src/main/services/achievements/processAchievementFileDiff");
  ...
  it('should log "First change in file" when previousStat is undefined', () => {
    ...
    const {
      achievementsLogger,
    } = require("../src/main/services/achievements/achievementsLogger");
